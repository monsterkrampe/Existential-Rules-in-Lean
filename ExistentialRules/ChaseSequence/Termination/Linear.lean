...
section Rules
  ...
  --general rules in (AtomsAndRules.Rule) allow lists of conjunctions in their head (instead of just cunjunctions of atoms), this is why the above def. is so complicated
